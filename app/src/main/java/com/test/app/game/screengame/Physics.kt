...
import com.test.app.game.datalist.QuestionP
import com.test.app.game.datalist.questionListP

@Composable
fun PhysicsScreen(navController: NavController) {
    ...
    val randomQuestions = remember {
        mutableStateOf(getRandomUniqueQuestions(questionListP))
    }
...
fun getRandomUniqueQuestions(questionList: List<QuestionP>): List<QuestionP>? {
